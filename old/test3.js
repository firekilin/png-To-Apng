...
const apngData = Buffer.concat ([pngSignature, ihdrChunk.getBuffer (), acTLCunk.getBuffer (), PLTECunk.getBuffer (), tRNSCunk.getBuffer (), body, IENDCunk.getBuffer ()]);
